 ...
 * IDL can be found at `target/idl/shadowstate_mxe.json`.
 */
export type ShadowstateMxe = {
  "address": "E3GFUytcsMFgYgwTrHoob1YvhB4UvqTzj4bFWzE5dNXe",
  "metadata": {
    "name": "shadowstateMxe",
    "version": "0.1.0",
    "spec": "0.1.0",
